...
>
> Новое ограничение паспорта — **R14** (§12): сигнал тишины только RMS, пауза тишиной не считается, подсказка фиксирована на 15 мин, стоп настраиваемый (30/60/120/never, default 30), рез только на авто-стопе, факт реза виден чипом.
>
...
## B32 · UI-фиксы по фидбеку (2026-07-30)
...
| R14 | Авто-стоп по тишине + рез хвоста — только RMS-сигнал, только на авто-стопе, opt-out `never`, видимый чип (секция T) |
