...
- **Шрифты**: Manrope + IBM Plex Mono (serif выпилен). [TD-47] До 2026-07 UI-шрифтом был Hanken Grotesk, но у него нет базовой кириллицы (U+0400–045F) — весь русский и казахский интерфейс уходил в системный фолбэк, а латиница оставалась Hanken: две гарнитуры в одной строке. Manrope выбран по покрытию (cyrillic, cyrillic-ext, greek, latin, latin-ext, vietnamese).
