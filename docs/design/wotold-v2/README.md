...
- **Шрифты**: Onest + IBM Plex Mono (serif выпилен). [TD-47] До 2026-07 UI-шрифтом был Hanken Grotesk, но у него нет базовой кириллицы (U+0400–045F) — весь русский и казахский интерфейс уходил в системный фолбэк, а латиница оставалась Hanken: две гарнитуры в одной строке. Onest выбран владельцем по внешнему виду — кириллица-first геометрическая гротеска, ближе всего к прежнему Hanken по темпераменту. Покрытие: cyrillic, cyrillic-ext, latin, latin-ext; греческий и вьетнамский добавим, если появятся соответствующие локали.
