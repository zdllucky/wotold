/* eslint-disable */
// WOTOLD UIKIT · icons — fresh line set, 24 viewBox, 1.6 stroke, currentColor.
...
const WK_ICONS = {
  ...
  settings: <><circle cx="12" cy="12" r="3" /><path d="M19 12a7 7 0 0 0-.1-1.3l2-1.5-2-3.4-2.3 1a7 7 0 0 0-2.3-1.3L13.8 2h-3.6l-.4 2.5A7 7 0 0 0 7.5 5.8l-2.3-1-2 3.4 2 1.5A7 7 0 0 0 5 12c0 .4 0 .9.1 1.3l-2 1.5 2 3.4 2.3-1a7 7 0 0 0 2.3 1.3l.4 2.5h3.6l.4-2.5a7 7 0 0 0 2.3-1.3l2.3 1 2-3.4-2-1.5c.1-.4.1-.9.1-1.3z" /></>,
  user: <><circle cx="12" cy="8" r="4" /><path d="M4 20a8 8 0 0 1 16 0" /></>,
  users: <><circle cx="9" cy="8" r="3.5" /><path d="M3 19a6 6 0 0 1 12 0" /><path d="M16 5.5a3.5 3.5 0 0 1 0 7M17.5 13.5A6 6 0 0 1 21 19" /></>,
  ...
  doc: <><path d="M6 3h8l4 4v13a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1z" /><path d="M14 3v4h4M8.5 12.5h7M8.5 16h5" /></>,
  ...
  chat: <path d="M4 6.5A2.5 2.5 0 0 1 6.5 4h11A2.5 2.5 0 0 1 20 6.5v8a2.5 2.5 0 0 1-2.5 2.5H11l-4.5 3.6V17h-.5A2.5 2.5 0 0 1 3.5 14.5z" transform="translate(.5 0)" />,
  ...
  trash: <path d="M4 7h16M10 4h4M9 7l.6 13a1 1 0 0 0 1 1h2.8a1 1 0 0 0 1-1L15 7" />,
  download: <><path d="M12 3v12M7.5 10.5L12 15l4.5-4.5" /><path d="M5 20h14" /></>,
  upload: <><path d="M12 21V9M7.5 13.5L12 9l4.5 4.5" /><path d="M5 4h14" /></>,
  ...
  key: <><circle cx="8" cy="8" r="3.5" /><path d="M10.5 10.5L19 19M16 16l2-2M14 18l1.5-1.5" /></>,
  ...
  alert: <><path d="M12 4L2.5 20.5h19z" /><path d="M12 10v5M12 18v.4" /></>,
  info: <><circle cx="12" cy="12" r="8.5" /><path d="M12 11v5M12 8v.4" /></>,
  checkCircle: <><circle cx="12" cy="12" r="8.5" /><path d="M8 12.3l2.6 2.6L16 9.4" /></>,
  arrowRight: <path d="M4 12h15M13 6l6 6-6 6" />,
  arrowUp: <path d="M12 20V5M6 11l6-6 6 6" />,
  sun: <><circle cx="12" cy="12" r="4" /><path d="M12 2v2M12 20v2M4 12H2M22 12h-2M5.5 5.5L4 4M20 20l-1.5-1.5M18.5 5.5L20 4M4 20l1.5-1.5" /></>,
  moon: <path d="M20 13.5A8 8 0 1 1 10.5 4a6.5 6.5 0 0 0 9.5 9.5z" />,
  external: <><path d="M14 4h6v6M20 4l-9 9" /><path d="M18 14v4a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4" /></>,
  copy: <><rect x="9" y="9" width="11" height="11" rx="2" /><path d="M5 15a2 2 0 0 1-1-1.7V6a2 2 0 0 1 2-2h7A2 2 0 0 1 16 5" /></>,
  ...
  scissors: <><circle cx="6" cy="7" r="2.4" /><circle cx="6" cy="17" r="2.4" /><path d="M8 8.5L20 18M8 15.5L20 6" /></>,
  bolt: <path d="M13 3L5 13h5l-1 8 8-10h-5z" />,
  send: <path d="M5 12l15-7-7 15-2-6z" />,
  globe: <><circle cx="12" cy="12" r="8.5" /><path d="M3.5 12h17M12 3.5c2.5 2.3 4 5.4 4 8.5s-1.5 6.2-4 8.5c-2.5-2.3-4-5.4-4-8.5s1.5-6.2 4-8.5z" /></>,
  ...
  calendarWeek: <><rect x="3" y="5" width="18" height="15" rx="2" /><path d="M3 10h18M8 3v4M16 3v4M8 14v3M12 14v3M16 14v3" /></>,
...
function Icon({ name, size = 16, stroke = 1.6, style, className, title }) {
  const p = WK_ICONS[name];
  if (!p) return <span style={{ display: 'inline-block', width: size, height: size, ...style }} aria-hidden="true" />;
  return (
...
Object.assign(window, { Icon, WK_ICONS });
