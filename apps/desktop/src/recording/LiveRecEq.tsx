...
// подписку на audio:level и изолирует 30Hz-перерендер В СЕБЕ — родительский
// контрол (навбар/рейл/минирейл) не перерисовывается на каждый сэмпл.
//
// Источник тот же, что у нижней плашки/виджета: Swift-сайдкар шлёт audio:level
// каждые 100ms; RecEq берёт последние 3 сэмпла → высоты баров.
