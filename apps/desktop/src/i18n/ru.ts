...
const ruInternal = {
  ...
  settings: {
    ...
    speakersMicDiarizationHint:
      'Полезно для записи живых встреч в одной комнате, когда на ваш микрофон попадают и другие участники. Замедляет обработку звонка на ~10–20% (локальный движок делает дополнительный проход sortformer). Голос владельца устройства узнаётся по накопленным образцам или по основному говорящему.',
