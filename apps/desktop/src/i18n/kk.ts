...
export const kk: TranslationStrings = {
  ...
  errors: {
    ...
    notReady: {
      human: 'Өңдеу үшін бағдарламалық модульдер жетіспейді.',
      hint: '«Жүктеу» түймесін басыңыз — модульдер орнағанда қоңырау өзі өңделеді.',
    },
    modelTampered: {
      human: 'Модуль файлы тұтастық тексерісінен өтпеді.',
      hint: '«Жүктеу» түймесін басыңыз — бүлінген файл ауыстырылады.',
    },
    modelMissing: {
      human: 'Жергілікті модель орнатылмаған.',
      hint: 'Оны Баптаулар → Өңдеу бөлімінен жүктеңіз.',
    },
    presetNotSet: {
    ...
    permissionsProbe: {
      human: 'Рұқсаттарды тексеру мүмкін болмады — дыбыс жазу компоненті жауап бермеді.',
      hint: 'Wotold-ты қайта іске қосыңыз. Қайталанса — қосымшаны қайта орнатып, бізге хабарлаңыз.',
    },
    permissionsProbeTimeout: {
      human: 'Рұқсат сұрауы жауапсыз қалды.',
      hint: 'Жүйелік диалог басқа терезенің артында қалып қойған болуы мүмкін. «Сұрау» батырмасын қайта басыңыз.',
    },
    permissionReset: {
      human: 'Қол жеткізуді ысыру мүмкін болмады.',
      hint: 'Жүйе баптаулары → Құпиялылық және Қауіпсіздік бөлімін ашып, Wotold құсбелгісін қолмен алып тастаңыз, содан кейін рұқсатты қайта сұраңыз.',
    },
    micPermission: {
  ...
  common: {
    ...
    dismiss: 'Жабу',
    dismissToast: 'Хабарламаны жабу: {message}',
    cancel: 'Болдырмау',
    delete: 'Жою',
    deleting: 'Жойылуда…',
    edit: 'Өңдеу',
  ...
  settings: {
    ...
    // [T3/R15] Белсенді жазбадағы тыныштық.
    silencePromptHint:
  ...
  permissions: {
    ...
    staleHint:
      'Егер бұл рұқсатты бұрын берген болсаңыз, macOS оны жоғалтқан болуы мүмкін: ол қосымшаның қолтаңбасына байланған және Wotold жаңартылғанда сақталмайды. Жүйе баптауларындағы құсбелгі бәрібір орнында қалады.',
    reset: 'Қол жеткізуді ысыру',
    resetTitle: 'Қол жеткізуді ысырып, қайта сұрау',
    resetBody:
      'macOS осы сұранысқа берген алдыңғы жауабын ұмытып, жүйелік диалогты қайта көрсетеді. Осы рұқсаттан басқа ештеңе өзгермейді.',
    resetConfirm: 'Ысырып, сұрау',
    request: 'Сұрау',
  ...
  voiceModel: {
    featureOff:
      '⚠ Бұл құрастырма voice-onnx-сыз жиналған: дауыстар салыстырылмайды, сондықтан спикерлерді контактілерге байлау жұмыс істемейді. Әдеттегі құрастырмада мүмкіндік қосулы.',
  },
  ...
  recording: {
    ...
    announceRecording: 'Жазба жүріп жатыр',
    announcePaused: 'Жазба кідіртілді',
    announceIdle: 'Жазба жүрген жоқ',
    ...
    // [T7/R15] SilencePrompt — белсенді жазбадағы тыныштық.
  ...
  readiness: {
    eyebrow: 'Жергілікті өңдеу',
    missing: 'Қоңырауларды өңдеуге бағдарламалық модульдер жетіспейді — {size}.',
    download: 'Жүктеу',
    downloading: 'Модульдер жүктелуде… {pct}%',
    downloadingAria: 'Модульдерді жүктеу барысы',
    retry: 'Қайталау',
    verifyFailed: 'Модуль файлы тұтастық тексерісінен өтпеді — қайталап көріңіз.',
    choosePreset: 'Алдымен қозғалтқыш өлшемін таңдаңыз — не жүктелетіні одан тәуелді.',
    openSettings: 'Баптауларды ашу',
    callParked: 'Қоңырау күтуде: бағдарламалық модульдер жетіспейді. Модульдер орнағанда өзі өңделеді.',
    callParkedDownload: 'Жүктеу',
    queueWaiting: 'Кезек модульдердің жүктелуін күтуде',
  },
  queue: {
