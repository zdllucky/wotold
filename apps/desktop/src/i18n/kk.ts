...
export const kk: TranslationStrings = {
  ...
  assistant: {
    ...
    suggest1: 'Құпиялылықты қашан талқыладық?',
    suggest2: 'Дмитрийдің осы аптадағы барлық тапсырмалары',
    suggest3: '«Контурға» демода не уәде етілді?',
    suggest4: 'Өнім жиналысының шешімдері',
