...
export const kk: TranslationStrings = {
  ...
  settings: {
    ...
    ledeAppearance: 'Тақырып бірден қолданылады.',
    ledeAccount: 'Кіру міндетті емес — Wotold жергілікті жұмыс істейді.',
    ledeProcessing: 'Қоңыраулар қай жерде өңделеді.',
    ledePermissions: 'Микрофон мен жүйелік дыбысқа рұқсатсыз жазба басталмайды.',
    ledeRecording: 'Тілдер, ыстық пернелер, авто-анықтау.',
    ledeSpeakers: 'Әңгімелесушілерді дауыс арқылы тану.',
    ledeLabs: 'Эксперименттік функциялар.',
    ledeMaintenance: 'Жинақталған деректермен операциялар.',
    ledePrivacy: 'Жергілікті деректерді толық тазарту.',
    ...
    bulkRecapRowLabel: 'Бос қорытындылар',
    bulkRecapRowHint: 'Бұрын өңделген, қорытындысы жасалмаған қоңыраулар үшін қайта жасау.',
    bulkRecapDoneShort: '{n} дайын',
