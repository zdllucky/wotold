...
export const kk: TranslationStrings = {
  ...
  callDetail: {
    ...
    engineCloud: 'бұлт (Wotold proxy)',
    engineLocalLight: 'жергілікті Qwen 1.5B (Light)',
    engineLocalBalanced: 'жергілікті Qwen 3B (Balanced)',
    engineLocalQuality: 'жергілікті Qwen 7B (Quality)',
    engineLocalGeneric: 'жергілікті қозғалтқыш',
    retry: 'Қайтадан көру',
  ...
  settings: {
    ...
    hotkeyToggleLabel: 'Ыстық перне · бастау/тоқтату',
    hotkeyToggleHint:
      '«Жазу» басыңыз да тіркесімді басыңыз (мысалы ⌘⇧R). Esc — бас тарту. Жүйелік тіркесімдерге тыйым.',
    hotkeyPauseLabel: 'Ыстық перне · кідірту/жалғастыру',
    ...
    callDetectCheckboxLabel:
      'Жүйе қоңырауды анықтаса (микрофон басқа қосымшамен қолданылуда + Zoom/Teams/Meet/FaceTime/Discord/Telegram алдыңғы планда), Wotold «Жазу?» хабарламасын көрсетеді. Терезе жабылып тұрса да жұмыс істейді. macOS Core Audio + қосымшалар тізіміне сүйенеді; басқа қосымшаның дыбысы оқылмайды.',
    callDetectHint:
      'Сөндірілсе — Wotold ешқашан өзі ұсынбайды, тек ⌘⇧R немесе батырма арқылы. Құпиялылық үшін сөндіру ұсынылады (R3 паспорт).',
    callDetectCooldownLabel: 'Қайта ұсынбау',
    callDetectCooldownOption: '{n} мин',
    callDetectCooldownHint:
      'Ұсынысты жапсаңыз — сол қосымша үшін ең аз осы уақыт ішінде көрсетпейміз. Қайта іске қосқанда нөлге түседі.',
