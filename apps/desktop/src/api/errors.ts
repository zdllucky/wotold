...
const PATTERNS: ErrorPattern[] = [
  ...
  // Бэкенд теперь не сохраняет такое молча, а возвращает ошибку.
  {
    ...
    hint: 'Попробуй пересоздать саммари ещё раз или переключись на облако в Настройках.',
  },
  ...
  // если попала в UI — задача корректно завершилась, spinner снят.
  {
    ...
    hint: 'Попробуй ещё раз. Если повторится — переключись на облако в Настройках.',
  },
