...
interface CommandPaletteProps {
  ...
  /** [B34.4] Открыть раздел настроек и (опционально) подсветить строку. */
...
interface FlatItem {
  ...
  kbd?: string;
  meta?: string;
  /** [B34.4] Дополнительные слова для поиска — подпись у пункта одна, а искать
   *  его хочется и по имени родителя («настройки», «внешний вид»). */
  keywords?: string[];
  run: () => void;
}

/** [B34.4] Сколько строк настроек показываем — как звонки ограничены восемью.
...
export function CommandPalette({
  ...
  // [B34.4] Разделы настроек и отдельные строки. Раньше палитра умела только
