...
3. Без заголовков-секций и без буллетов — только связные абзацы.\n\
4. Верни РОВНО ОДИН JSON-объект: {{ \"narrative\": \"...markdown-абзацы...\" }}. Никакого текста вне JSON.\n\
5. Язык всего текста — {lang}."
    )
}
