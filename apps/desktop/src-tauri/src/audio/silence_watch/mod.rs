...
//! галлюцинации в транскрипт и рекап. R15 паспорта разрешает предложить стоп
...
//! R15 запрещает домысливать «идёт ли собрание» по процессам и frontmost-app
...
/// Порог подсказки «может, остановить?». Фиксированный (R15) — настройкой
