...
use crate::assistant::types::{
    AssistantAnswer, AssistantChatMeta, AssistantMessage, AssistantRole,
};
use crate::AppError;

// [TD-41] Пассажи индекса переехали в assistant_passages.rs; фасад сохранён,
// чтобы 20+ существующих  путей не переписывать.
pub(crate) use super::assistant_passages::*;
